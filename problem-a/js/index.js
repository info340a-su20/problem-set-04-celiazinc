...
var coolExist = motto.indexOf("cool");
console.log(coolExist >= 0);
...
let newMottoLength = motto.length;
var ratio = ((newMottoLength / mottoLength) * 100).toFixed(2);
